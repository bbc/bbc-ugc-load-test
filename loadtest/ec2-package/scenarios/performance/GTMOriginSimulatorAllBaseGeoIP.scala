...
class GTMOriginSimulatorAllBaseGeoIP(val run_time: Int = 15, val requests_per_second_per_scenario: Int = 20, val base_url: String) extends Simulation {
  ...
  val scn_news404 = scenario("news404")
    .exec(rand_octets)
    .exec(http("news404")
    .get("/origin-simulator?page=news404&delay_min_msec=100&delay_max_msec=200")
    .header("my_ip", "169.${octet_2}.${octet_3}.${octet_4}"))
    // .header("my_ip", "${octet_1}.${octet_2}.${octet_3}.${octet_4}"))

  val scn_news = scenario("news")
    .exec(rand_octets)
    .exec(http("news")
    .get("/origin-simulator?page=news&delay_min_msec=100&delay_max_msec=200")
    .header("my_ip", "${octet_1}.${octet_2}.${octet_3}.${octet_4}"))

  val scn_sport = scenario("sport")
    .exec(rand_octets)
    .exec(http("sport")
    .get("/origin-simulator?page=sport&delay_min_msec=100&delay_max_msec=200")
    .header("my_ip", "${octet_1}.${octet_2}.${octet_3}.${octet_4}"))

  val scn_iplayer = scenario("iplayer")
    .exec(rand_octets)
    .exec(http("iplayer")
    .get("/origin-simulator?page=iplayer&delay_min_msec=100&delay_max_msec=200")
    .header("my_ip", "${octet_1}.${octet_2}.${octet_3}.${octet_4}"))

  val scn_weather = scenario("weather")
    .exec(rand_octets)
    .exec(http("weather")
    .get("/origin-simulator?page=weather&delay_min_msec=100&delay_max_msec=200")
    .header("my_ip", "${octet_1}.${octet_2}.${octet_3}.${octet_4}"))

  val scn_radio = scenario("radio")
    .exec(rand_octets)
    .exec(http("radio")
    .get("/origin-simulator?page=radio&delay_min_msec=100&delay_max_msec=200")
    .header("my_ip", "${octet_1}.${octet_2}.${octet_3}.${octet_4}"))

  val scn_homepage = scenario("homepage")
    .exec(rand_octets)
    .exec(http("homepage")
    .get("/origin-simulator?page=homepage&delay_min_msec=100&delay_max_msec=200")
    .header("my_ip", "${octet_1}.${octet_2}.${octet_3}.${octet_4}"))
