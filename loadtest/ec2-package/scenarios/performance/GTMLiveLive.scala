...
class GTMLiveLive extends Simulation {
  ...
  val euWestHttpConf = http
    .baseURL("https://www.bbc.com.europe-west-1.live-live.gtm-edge.e9fb45cfcc47b85b.xhst.bbci.co.uk")
  ...
  val euCentralHttpConf = http
    .baseURL("https://www.bbc.com.europe-central-1.live-live.gtm-edge.e9fb45cfcc47b85b.xhst.bbci.co.uk")
    .acceptHeader("text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8")
    .doNotTrackHeader("1")
    .acceptLanguageHeader("en-GB,en-US;q=0.8,en;q=0.6")
    .acceptEncodingHeader("gzip, deflate")
